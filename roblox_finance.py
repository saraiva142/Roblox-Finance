...
## SABER O MINIMO QUE POSSO COMPRAR##############################
...
def estrategia_trade(dados, codigo_ativo, ativo_operado, quantidade, posicao):
    ...
    print(f"Ultima Media Rapida: {ultima_media_rapida} | Ultima Media Devagar: {ultima_media_devagar} ")
    
    conta = cliente_binance.get_account()

    ## VERIFICAR QUANTIDADE ATUAL DE ATIVO
